...
//                return
//            }
//            VietmapAutomotiveFlutterPlugin.findListItem(elementId: args, actionWhenFound: { item in
//                item.stopHandler()
//            })
//            result(true)
...
//            }
//
//            VietmapAutomotiveFlutterPlugin.findSearchTemplate(elementId: elementId, actionWhenFound: { template in
...
//        VietmapAutomotiveFlutterPlugin.findInformationTemplate(elementId: elementId) { infoTemplate in
...
//        VietmapAutomotiveFlutterPlugin.findListTemplate(elementId: elementId) { listTemplate in
...
//        VietmapAutomotiveFlutterPlugin.findListItem(elementId: elementId) { item in
...
//        let filteredTemplates = VietmapAutomotiveFlutterPlugin.cpTemplateHistory.filter { $0 is CPSearchTemplate }
//
